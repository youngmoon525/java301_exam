public class UserDTO {
	protected int student_no;
	protected String user_id;
	protected String user_pw;
	protected String first_name;
	protected String last_name;
	protected String create_ymd;
	protected String update_ymd;
	protected String admin_yn;
	protected int money;



	protected UserDTO(int student_no, String user_id, String user_pw, String first_name, String last_name,
