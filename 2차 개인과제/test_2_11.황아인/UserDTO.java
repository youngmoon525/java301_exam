...
public class UserDTO {
	...
	private int money;
	public UserDTO() {}
	public UserDTO(int student_no, String user_id, String user_pw, String first_name, String last_name, String create_ymd,
			String update_ymd, String admin_yn, int money) {
		super();
