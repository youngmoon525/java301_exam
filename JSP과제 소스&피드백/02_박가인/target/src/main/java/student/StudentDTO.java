...
public class StudentDTO {
	private String user_id,user_pw,first_name, last_name,create_ymd,update_ymd,admin_yn,student_name;
	private int student_no,money;
	public StudentDTO(String user_id, String user_pw, String first_name, String last_name, String student_name,
			int student_no) {
